...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.GetPlayerData(function(PlayerData)
        ...
        if PlayerData.job.onduty then if PlayerData.job.name == "medusa" then TriggerServerEvent("QBCore:ToggleDuty") end end
    end)
end)
...
AddEventHandler('onResourceStart', function(r) if GetCurrentResourceName() ~= r then return end
	QBCore.Functions.GetPlayerData(function(PlayerData) PlayerJob = PlayerData.job if PlayerData.job.name == "medusa" then onDuty = PlayerJob.onduty end end)
end)

CreateThread(function()
	local bossroles = {}
	for grade in pairs(QBCore.Shared.Jobs["medusa"].grades) do
		if QBCore.Shared.Jobs["medusa"].grades[grade].isboss then
			if bossroles["medusa"] then
				if bossroles["medusa"] > tonumber(grade) then bossroles["medusa"] = tonumber(grade) end
			else bossroles["medusa"] = tonumber(grade)	end
		end
	end

	if Config.MLO == "gabz" then
		Targets["UniFridge"] =
		exports['qb-target']:AddBoxZone("UniFridge", vector3(748.90545, -574.6492, 29.409837), 1.5, 0.6, { name="UniFridge"},
			{ options = { {  event = "qb-medusaclub:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "medusa", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge2"] =
		exports['qb-target']:AddBoxZone("UniFridge2", vector3(748.53118, -569.9326, 29.158315), 1.5, 0.6, { name="UniFridge2"},
			{ options = { {  event = "qb-medusaclub:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "medusa", shop = Config.DrinkItems }, }, distance = 1.5 })

		Targets["UniCounter"] =
		exports['qb-target']:AddBoxZone("UniCounter", vector3(746.55883, -569.9694, 29.491273), 1.1, 1.0, { name="UniCounter"},
			{ options = { { event = "qb-medusaclub:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter" }, }, distance = 2.0 })

		Targets["UniReceipt"] =
		exports['qb-target']:AddBoxZone("UniReceipt", vector3(745.56628, -573.3391, 29.491212), 0.6, 0.6, { name="UniReceipt"},
			{ options = { { event = "qb-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "medusa",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/medusaclub-GTAV-Logo.png/ width=225px></p>"
							} }, distance = 2.0 })

		Targets["UniClockin"] =
		exports['qb-target']:AddBoxZone("UniClockin", vector3(748.16552, -551.82, 33.691894), 0.8, 0.3, { name="UniClockin"},
			{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "medusa" }, }, distance = 2.0 })

		Targets["UniBoss"] =
		exports['qb-target']:AddBoxZone("UniBoss", vector3(753.86505, -582.5697, 33.390724), 0.6, 0.6, { name="UniBoss"},
	...
	elseif Config.MLO == "van" then
		...
		exports['qb-target']:AddBoxZone("UniDoor", vector3(138.12, -1292.51, 29.23), 0.6, 2.6, { name="UniDoor", heading = 30.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 31.03, },
			{ options = { { event = "qb-medusaclub:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["bar_access"],"Bar Access", job = "medusa", door = 1 }, }, distance = 2.0	})
		Targets["UniDoor2"] =
		exports['qb-target']:AddBoxZone("UniDoor2", vector3(132.83, -1288.03, 29.27), 0.6, 1.4, { name="UniDoor2", heading = 30.0, debugPoly=Config.Debug, minZ = 28.27, maxZ = 30.57, },
			{ options = { { event = "qb-medusaclub:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["bar_exit"],"Bar Exit", job = "medusa", door = 2 }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UniWash1", vector3(130.4, -1286.45, 29.28), 0.8, 0.6, { name="UniWash1", heading = 30.0, debugPoly=Config.Debug, minZ = 28.68, maxZ = 29.28, },
			{ options = { { event = "qb-medusaclub:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = "medusa" }, }, distance = 1.5 })
		...
		exports['qb-target']:AddBoxZone("UniFridge", vector3(128.89, -1284.18, 29.28), 3.8, 0.5, { name="UniFridge", heading = 30.0, debugPoly=Config.Debug, minZ=28.28, maxZ=29.27 },
			{ options = { {  event = "qb-medusaclub:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], shop = 1, job = "medusa", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge2"] =
		...
		exports['qb-target']:AddBoxZone("UniFridge4", vector3(129.35, -1279.92, 29.27), 0.75, 0.6, { name="UniFridge4", heading = 50.0, debugPoly=Config.Debug, minZ = 29.47, maxZ = 30.47, },
			{ options = { {  event = "qb-medusaclub:Shop", icon = "fas fa-archive", label = "Open Food Fridge", shop = 2, job = "medusa", shop = Config.FoodItems }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UniCounter", vector3(128.15, -1283.48, 29.27), 0.8, 1.1, { name="UniCounter", heading = 30.0, debugPoly=Config.Debug, minZ = 29.07, maxZ = 29.87, },
			{ options = { { event = "qb-medusaclub:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"],"Open Counter", stash = "Counter" }, }, distance = 2.5 })
		...
		exports['qb-target']:AddBoxZone("UniCocktails", vector3(130.97, -1282.68, 29.27), 0.55, 0.4, { name="UniCocktails", heading = 30.0, debugPoly=Config.Debug, minZ= 29.27, maxZ= 29.87 },
			{ options = { { event = "qb-medusaclub:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_cocktails"], job = "medusa", craftable = Crafting.Cocktails, header = Loc[Config.Lan].menu["cocktail"] }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UniCoffee", vector3(130.86, -1281.61, 29.27), 0.4, 0.6, { name="UniCoffee", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "qb-medusaclub:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "medusa", id = "coffee"}, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UniOven", vector3(133.22, -1286.38, 29.27), 0.4, 0.8, { name="UniOven", heading = 300.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 29.87, },
			{ options = { { event = "qb-medusaclub:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = "medusa", craftable = Crafting.Food, header = Loc[Config.Lan].menu["oven"] }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UniTap", vector3(128.08, -1282.65, 29.27), 0.2, 0.3, { name="UniTap", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 29.87, },
			{ options = { { event = "qb-medusaclub:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "medusa", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer"] }, }, distance = 1.5 })
	...
	for i = 1, #Config.Locations do
		if Config.Locations[i].Booth.enableBooth then
			...
			exports['qb-target']:AddCircleZone("UniBooth"..i, Config.Locations[i].Booth.coords, 0.75, {name="UniBooth"..i, debugPoly=Config.Debug, useZ=true, },
				{ options = { { event = "qb-medusaclub:client:playMusic", icon = "fab fa-youtube", label = Loc[Config.Lan].targetinfo["dj_booth"], job = "medusa", zone = i, }, }, distance = 2.0 })
		end
	end
end)

RegisterNetEvent('qb-medusaclub:Door', function(data)
    DoScreenFadeOut(500)
...
RegisterNetEvent('qb-medusaclub:washHands', function(data)
...
RegisterNetEvent('qb-medusaclub:Stash', function(data)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "medusa_"..data.stash)
    TriggerEvent("inventory:client:SetCurrentStash", "medusa_"..data.stash)
end)

RegisterNetEvent('qb-medusaclub:Shop', function(data)
	...
	TriggerServerEvent(event, "shop", "medusaclub", data.shop)
end)

RegisterNetEvent('qb-medusaclub:Crafting:MakeItem', function(data)
	local bartext = ""
	...
	{}, {}, function()
		TriggerServerEvent('qb-medusaclub:Crafting:GetItem', data.item, data.craft)
		Wait(500) -- Delay
		TriggerEvent("qb-medusaclub:Crafting", data)
	end, function() -- Cancel
		TriggerEvent('inventory:client:busy:status', false)
	end, data.item)
end)

RegisterNetEvent('qb-medusaclub:Crafting', function(data)
	local Menu = {}
	...
	for i = 1, #data.craftable do
		for k, v in pairs(data.craftable[i]) do
			if k ~= "amount" then
				...
				Menu[#Menu + 1] = { disabled = disable, icon = k, header = setheader, txt = settext, params = { event = "qb-medusaclub:Crafting:MakeItem", args = { item = k, craft = data.craftable[i], craftable = data.craftable, header = data.header } } }
...
function FoodProgress(ItemMake, craftable)
	...
	{}, {}, function()
		TriggerServerEvent('qb-medusaclub:Crafting:GetItem', ItemMake, craftable)
	end, function() -- Cancel
		TriggerEvent('inventory:client:busy:status', false)
		triggerNotify(nil, Loc[Config.Lan].error["cancelled"], 'error')
	end, ItemMake)
...
RegisterNetEvent('qb-medusaclub:JustGive', function(data) if not onDuty then triggerNotify(nil, Loc[Config.Lan].error["not_cloked_in"], 'error') else FoodProgress(data.id) end end)

RegisterNetEvent('qb-medusaclub:client:DrinkAlcohol', function(itemName)
...
RegisterNetEvent('qb-medusaclub:client:Drink', function(itemName)
...
RegisterNetEvent('qb-medusaclub:client:Eat', function(itemName)
...
RegisterNetEvent('qb-medusaclub:client:playMusic', function(data)
	exports['qb-menu']:openMenu({
		{ isMenuHeader = true, header = '<center><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/medusaclub-GTAV-Logo.png/ width=225px>' },
		{ icon = "fas fa-circle-xmark", header = "", txt = Loc[Config.Lan].menu["close"], params = { event = "qb-menu:client:closemenu" } },
		{ icon = "fab fa-youtube", header = Loc[Config.Lan].menu["play_song"], txt = Loc[Config.Lan].menu["youtube_link"], params = { event = 'qb-medusaclub:client:musicMenu', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-pause", header = Loc[Config.Lan].menu["pause_music"], txt = Loc[Config.Lan].menu["pause_music"], params = { isServer = true, event = 'qb-medusaclub:server:pauseMusic', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-play", header = Loc[Config.Lan].menu["resume_music"], txt = Loc[Config.Lan].menu["resume_music"], params = { isServer = true, event = 'qb-medusaclub:server:resumeMusic', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-volume-off", header = Loc[Config.Lan].menu["volume"], txt = Loc[Config.Lan].menu["change_volume"], params = { event = 'qb-medusaclub:client:changeVolume', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-stop", header = Loc[Config.Lan].menu["turn_off_music"], txt = Loc[Config.Lan].menu["stop_music"], params = { isServer = true, event = 'qb-medusaclub:server:stopMusic', args = { zoneNum = data.zone } } } })
end)
RegisterNetEvent('qb-medusaclub:client:musicMenu', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-medusaclub:server:playMusic', dialog.song, data.zoneNum)
    end
end)
RegisterNetEvent('qb-medusaclub:client:changeVolume', function(data)
    local dialog = exports['qb-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-medusaclub:server:changeVolume', dialog.volume, data.zoneNum)
    end
end)
