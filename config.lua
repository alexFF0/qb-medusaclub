...
Config = {
	...
	JimShop = false, -- Enable this to use qb-shops for buying ingredients
	...
	Locations = {
		{
			...
			blipcolor = 61,
			garage = { spawn = vector4(115.86235, -1309.449, 29.218021, 208.232),
				out = vector4(115.8486, -1318.118, 29.059974, 113.99773),
				list = { "panto", "burrito3" }
			},
